...
function UpdateTodoList({ onUpdateOpen }) {
  const { updateListById, currentCheckedList } = useTodoContext();
  const [values, setValues] = useState({
    id: currentCheckedList.id,
    title: currentCheckedList.title,
    dueDate: currentCheckedList.dueDate,
  });
